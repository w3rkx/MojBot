...
client.on("messageCreate", async message=>{
    ...
    if(message.content === "!MysteryBoxZaFree"){

        message.reply("Wygrales MB zrob ticketa i wyslij screena na ticketa Gratulacje");
...
async def sayd(ctx, *, tekst):
    ...
    embed.set_footer(
        text=f"Wysłane przez {ctx.author}",
...
console.log("TOKEN:", process.env.TOKEN ? "OK" : "BRAK");
